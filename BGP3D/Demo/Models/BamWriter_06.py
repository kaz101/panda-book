...
class BamWriter:
	def __init__(self):
		...
		self.modelRoot.writeBamFile("GreenTurret.bam")
	...
	def setupModels(self):
		...
		self.turret =  loader.loadModel("../Models/Turret.egg")
		self.turret.reparentTo(self.modelRoot)
		# Loads the molding model and adds it to the scene.
		
		self.teamTex = loader.loadTexture("../Images/GreenTeamTex.png",
			"../Images/HighGloss.png")
		# Loads the image RedTeamTex.png as an RGB image, 
		# and stuffs HighGloss.png into it's Alpha component.
		
		self.turret.setTexture(self.glossTS, self.teamTex)
		...
		self.turret.setTexture(self.normalTS, self.normalTex)

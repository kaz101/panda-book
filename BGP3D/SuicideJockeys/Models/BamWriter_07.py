...
class BamWriter:
	def __init__(self):
		...
		self.modelRoot.writeBamFile("Disc.bam")
	...
	def setupModels(self):
		...
		self.d1 =  loader.loadModel("../Models/Disc01Part1.egg")
		self.d1.reparentTo(self.modelRoot)
		self.d2 =  loader.loadModel("../Models/Disc01Part2.egg")
		self.d2.reparentTo(self.modelRoot)
		...
		self.d1.setTexture(self.glossTS, self.metalTex)
		self.d2.setTexture(self.glowTS, self.glowTex)

...
class BamWriter:
	def __init__(self):
		...
		self.modelRoot.writeBamFile("TargetCone.bam")
	...
	def setupModels(self):
		...
		self.model1 = loader.loadModel("../Models/TargetCone.egg")
		#self.model2 = loader.loadModel("../Models/LaserFlash.egg")
		#self.model2.setScale(.5, 1, .5)
		
		self.model1Tex = loader.loadTexture("../Images/TargetCone.png", "../Images/HighGlow.png")
		#self.model2Tex = loader.loadTexture("../Images/LaserLight.png", "../Images/HighGlow.png")
		
		self.model1.setTexture(self.glowTS, self.model1Tex)
		#self.model1.setTransparency(TransparencyAttrib.MAlpha)
		#self.model1.setColor(1,1,1,.5)
		
		#self.model2.setTexture(self.glowTS, self.model2Tex)
		
		self.model1.reparentTo(self.modelRoot)
		#self.model2.reparentTo(self.modelRoot)
		
		self.modelRoot.setLightOff()
